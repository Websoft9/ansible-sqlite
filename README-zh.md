...
包含的核心组件为：可选 SQLite 多个版本, CloudBeaver on Docker

更多请见 [参数表](/docs/zh/stack-components.md)

## 本项目安装的是 SQLite 最新版吗？

本项目只能安装 [SQLite 预设](https://github.com/Websoft9/role_sqlite/blob/main/vars/main.yml)的版本。  

我们会定期检查版本准确性，并努力增加更多的可选版本。  
