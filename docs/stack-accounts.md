...
Here are the required username and password for SQLite installation and configuration.

## SQLite

* SQLite administrator username: `admin`
* SQLite administrator password: Get it form the file of your server */credentials/password.txt*
